      ...
      <div className="h-full bg-white flex flex-col items-center justify-center space-y-12 p-8">
        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative bg-white rounded-xl shadow-lg border border-slate-200 mx-auto w-auto sm:w-96 h-48 overflow-hidden">
            ...
            <div className="bg-blue-600 text-white p-4">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-blue-500 rounded-lg animate-pulse"></div>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 opacity-10">
            <div className="absolute inset-0 border-2 border-blue-300 rounded-full animate-ping-slow"></div>
            <div className="absolute inset-4 border-2 border-blue-400 rounded-full animate-ping-slower"></div>
          </div>
        ...
        <div className="text-center space-y-6 max-w-2xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 pt-4">
            {[
              { label: 'Response Analysis', value: 'Processing', color: 'bg-blue-500' },
            ...
            {[
              ...
              <div key={item.label} className="space-y-1">
                ...
                <div className="h-1.5 bg-slate-200 rounded-full overflow-hidden">
                  <div 
                    className={`h-full bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full animate-progressBar ${item.width}`}
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col items-center justify-center p-8">
        <div className="text-center space-y-4">
          <div className="w-24 h-24 bg-gradient-to-r from-blue-200 to-indigo-200 rounded-full flex items-center justify-center mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-start justify-between gap-4 sm:gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 w-full lg:w-auto">
              ...
              <div className="text-center sm:text-left flex-1">
                ...
                <p className="text-gray-600 mb-2 sm:mb-3 text-sm sm:text-base">{interviews[0]?.candidate?.resumeProfile?.profileTitle}</p>
                ...
                <div className="flex flex-wrap justify-center sm:justify-start gap-2 sm:gap-4">
                  ...
                  <div className="flex items-center gap-1 sm:gap-2 text-gray-700 text-xs sm:text-sm">
                    ...
                    <span>Latest Score: {interviews[0]?.interviewProfile?.performanceScore || '0'}</span>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2 text-gray-600">
                          ...
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                            ...
                            selectedInterview.status === 'PENDING' || 'RESCHEDULED' ? 'bg-yellow-100 text-yellow-800' :
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {selectedInterview.interviewProfile?.recommendedRoles?.map((role, index) => (
                    <div
                      key={index}
                      className="group relative bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-5 hover:from-blue-100 hover:to-indigo-100 transition-all duration-300 cursor-pointer border border-blue-100"
                    >
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={index} className="flex items-center gap-4 p-3 hover:bg-gray-50 rounded-lg transition-colors">
                      ...
                      <button className="cursor-pointer px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors">
